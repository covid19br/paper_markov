...
##write the results
# write.csv(all.days,"comparison_interval_normal_production.csv",row.names = FALSE)
# beep(3)

#if dont want to run everything
all.days <- read.csv("comparison_interval_normal_production.csv")
df.2 <- c()
